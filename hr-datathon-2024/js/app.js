...
var displayAbout = function() {
	clearDisplayField();
	var tool_version = "Authors: Virginia Zamponi, Jessica O'Brien, Kevin O'Brien, Erik Jensen, Christopher Lynch and Ross Gore";
	var message = tool_version;
	...
	slider.append("div")
		  ...
		  .append("p")
		  .attr("class", "instructions-text text-justified")
		  .html("This Datathon has been developed by OERI / VMASC at ODU.");
	slider.append("div")
		  .classed("da-slide", true)
		  .append("p")
		  .attr("class", "instructions-text text-justified")
		  .html("The aim of this application is to capture probabilities of the interdependencies of components in the Hampton Roads hurricane evacuation routes. The application computes the resilience (i.e. probability the route will remain open) under a number of what-if scenarios.");
	slider.append("div")
		 .classed("da-slide", true)
		 .append("p")
		 .attr("class", "instructions-text text-justified")
...
var init = function() {
    ...
    d3.select("#workspace")
	  ...
	  .attr("src", "img/legend-removebg.png");
}();
