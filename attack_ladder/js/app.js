...
var displayHelp = function() {
	...
	slider.append("div")
		  ...
		  .append("p")
		  .attr("class", "instructions-text text-justified")
		  .html("<span class='instructions-text-title'> Load a Dataset: </span> From the <span class='instructions-text-control'>\'Load\\Save\'</span> menu option - select <span class='instructions-text-control'>\'Import CSV\'</span> to import a .csv file.");
	slider.append("div")
		  .classed("da-slide", true)
		  .append("p")
		  .attr("class", "instructions-text text-justified")
