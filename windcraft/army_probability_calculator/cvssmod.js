...
var CVSS = function (id, options) {
    ...
    this.bm = {
        AV: {
            N: {
                l: 'Network/Unclassified (N)',
                d: "<b>Worst:</b> The vulnerable component is bound to the network stack and the set of possible attackers extends beyond the other options listed below, up to and including theentire Internet. Such a vulnerability is often termed “remotely exploitable” and can be thought of as an attack being exploitable at the protocol level one or more network hops away (e.g., across one or more routers). An example of a network attack is an attacker causing a denial of service (DoS) by sending a specially crafted TCP packet across a wide area network (e.g., CVE-2004-0230). Vulnerabilities can be exploited from IP addresses across the DoDIN, NIPRNET, or Internet."
            },
            R: {
                l: 'Radio Frequency (RF)',
                d: "<b>Worse:</b> The attack may include active and/or passive techniques to record, replay, jam/deny, and/or gain information/access to the RF spectrum or connected systems and infrastructure."
            },
            A: {
                l: 'Adjacent (A)',
            ...
            L: {
                l: 'Local (L)',
                d: "<b>Worse:</b> The vulnerable component is not bound to the network stack and the attacker's path is via read/write/execute capabilities. Either: <ul><li>the attacker exploits the vulnerability by accessing the target system locally (e.g., keyboard, console), or remotely (e.g., SSH);</li><li>or the attacker relies on User Interaction by another person to perform actions required to exploit the vulnerability (e.g., using social engineering techniques to trick a legitimate user into opening a malicious document).</li></ul>"
            },
            S: {
                l: 'Supply Chain (S)',
                d: "<b>Bad:</b>The attack compromises hardware, software, or firmware leading to corruption, interference with, altered delivery, and/or injection of malicious code. It also addresses issues regarding chain of custody from producer to user; disruption of management and logistics processes affecting distribution and installation of components; and monitoring of technologies/threats that adversely impact confidence, integrity, or availability of materials provided to systems.</li></ul>"
            },
            C: {
                l: 'Closed/Restricted Networks (C)',
                d: "<b>Bad:</b> The attack compromises hardware, software, or infrastructure on a classified, closed, or restricted network (ex. SIPRNET, DREN)."
            },
            P: {
                l: 'Physical (P)',
        ...
        AC: {
            A: {
                l: 'Nascent (ATT 1)',
                d: "<b>Worst:</b> Adversary/attacker with little-to-no organized cyber capabilities, with no knowledge of a network's underlying systems or industry beyond publicly connected open-source information."
            },
            B: {
                l: 'Limited (ATT 2)',
                d: "<b>Worst:</b> Adversary/attacker is able to identify, and target, for espionage or attack easily accessible unencrypted networks running common operating systems using publicly available tool. Possesses some limited strategic planning."
            },
            C: {
                l: 'Moderate (ATT 3)',
                d: "<b>Bad:</b> Adversary/attacker is able to use customized malware to conduct wide-ranging intelligence collection operations, gain access to more isolated networks, and in some cases creates limited effects against defense critical infrastructure networks."
            },
            D: {
                l: 'Advanced (ATT 4)',
                d: "<b>Bad:</b> Adversary/attacker may conduct complex, long-term cyber attack operations that combine multiple intelligence sources to obtain access to high-value networks. May develop detailed technical and system knowledge of the target system to deploy more damaging cyber attacks."
            }
        },
        PR: {
            N: {
	...
	this.vector.innerHTML = 'CVSS:A/AV:_/AC:_/PR:_/UI:_/S:_';
    if (options.onsubmit) {
        f.appendChild(e('hr'));
